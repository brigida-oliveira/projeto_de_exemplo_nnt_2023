...
android {
    namespace = "com.brigida.projetodeteste"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.brigida.projetodeteste"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.google.android.libraries.places:places:3.2.0") //Places
